"""
Manual smoke-test script for the POST /user_cards endpoint.

Usage:
    python scripts/manual_post_test.py

Requires a locally running backend server on http://localhost:8000.
"""
